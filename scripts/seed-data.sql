...
INSERT INTO public.team_members (first_name, last_name, job_title, sort_order, published) VALUES
  ('Κατερίνα', 'Αλκατέρ', '', 1, true),
  ('Θεόδωρης', 'Αλκατέρ', '', 2, true)
ON CONFLICT DO NOTHING;
