...
const CERTIFICATIONS = [
  {
    ...
    desc: "Πιστοποίηση του συστήματος διαχείρισης ποιότητας για τον σχεδιασμό, την κατασκευή και τη συντήρηση δημόσιων και ιδιωτικών τεχνικών έργων.",
    year: "2025",
  ...
  },
  {
    ...
    org: "Σύστημα Ενεργειακής Διαχείρισης",
    desc: "Πιστοποίηση ενεργειακής διαχείρισης για τη βελτιστοποίηση της ενεργειακής απόδοσης σε κάθε κατασκευαστικό έργο.",
    year: "2025",
    certNo: "00.14.0236",
                    ...
                    <div className="relative z-10">
                      ...
                      {"certBody" in cert && cert.certBody && (
                        <div className="mt-4 pt-4 border-t border-white/5 flex items-center justify-between">
                          <span className="font-['Space_Mono'] text-[#E8E4DD]/40 text-xs">Φορέας: {cert.certBody}</span>
                          <span className="font-['Space_Mono'] text-[#E8E4DD]/40 text-xs">Ισχύς έως: {cert.validUntil}</span>
                        </div>
                      )}
                    </div>
                  </Wrapper>
