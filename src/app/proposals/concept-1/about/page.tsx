...
const MILESTONES = [
  ...
  { year: "2020", text: "Πιστοποίηση ISO 9001:2015 — Σύστημα Διαχείρισης Ποιότητας" },
  { year: "2024", text: "150+ ολοκληρωμένα έργα και συνεχής ανάπτυξη" },
];
        ...
        <div className="container mx-auto px-6 max-w-7xl">
          <div className="grid grid-cols-2 lg:grid-cols-4 divide-x divide-white/5">
            {STATS.map((stat, i) => (
              ...
              >
                <div className="text-4xl md:text-5xl font-bold text-[#E63B2E] mb-2">{stat.value}</div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {VALUES.map((v, i) => (
              <motion.div
                ...
                className="bg-[#1A1A1A] p-8 border border-white/5 group hover:border-[#E63B2E]/30 transition-colors"
              >
                <v.icon className="w-10 h-10 text-[#E63B2E] mb-6" />
          ...
          <div className="space-y-0">
            {MILESTONES.map((m, i) => (
              <motion.div
                ...
                className="flex items-start gap-8 py-8 border-b border-white/5"
              >
                <div className="text-3xl md:text-4xl font-bold text-[#E63B2E] shrink-0 w-24">{m.year}</div>
