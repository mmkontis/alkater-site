...
export default function ContactPageClient() {
  ...
  const CONTACT_INFO = [
    ...
    { icon: Phone, label: tc("phoneLabel"), value: "+30 26650 XXXXX", href: "tel:+3026650XXXXX" },
    { icon: MapPin, label: tc("hqLabel"), value: tc("hqValue") },
    { icon: Clock, label: tc("hoursLabel"), value: tc("hoursValue") },
  ];
  ...
  return (
    <InnerPageLayout>
      ...
      <section className="relative pt-32 pb-16 md:pt-40 md:pb-20 overflow-hidden min-h-[60vh] flex items-end">
        <div className="absolute inset-0 z-0">
          <iframe
            ...
            title="Leaflet map"
          />
          <div className="absolute inset-0" style={{ background: "linear-gradient(to top, var(--bg-tint-97), var(--bg-tint-97) 10%, rgba(17,17,17,0.80) 50%, rgba(17,17,17,0.40))" }} />
          <div className="absolute inset-0" style={{ background: "linear-gradient(to right, var(--bg-tint-70), transparent)" }} />
        </div>
        ...
        <div className="container mx-auto px-6 max-w-7xl relative z-10">
          ...
          <h1 className="text-5xl md:text-7xl lg:text-8xl font-bold tracking-tighter uppercase leading-[0.9] mb-6" style={{ color: "var(--text-primary)" }}>
            {t("heroTitle")}<br />
            <span className="text-[#E63B2E]">{t("heroTitleAccent")}</span>
          </h1>
      ...
      <section className="py-12 md:py-16 relative">
        <div className="absolute inset-0 pointer-events-none" style={{ background: "radial-gradient(ellipse 80% 80% at 50% 0%, var(--tint-6), transparent)" }} />
        <div className="container mx-auto px-6 max-w-7xl relative z-10">
      ...
      <section className="py-12 md:py-16 relative overflow-hidden">
        <div className="absolute inset-0 pointer-events-none" style={{ background: "radial-gradient(ellipse 60% 60% at 80% 50%, var(--tint-8), transparent)" }} />
        <div className="container mx-auto px-6 max-w-7xl relative z-10">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16">
            ...
            >
              ...
              <h2 className="text-4xl md:text-5xl lg:text-6xl font-bold tracking-tighter uppercase mb-6 leading-[1.1]" style={{ color: "var(--text-primary)" }}>
                {t("formSectionTitle")}<br />
                <span className="text-[#E63B2E]">{t("formSectionTitleAccent")}</span>
              </h2>
              ...
              <div className="space-y-4">
                <a
                  ...
                  style={{ backgroundColor: "var(--bg-tint-85)", border: "1px solid var(--tint-border-15)" }}
                >
                  <div className="w-10 h-10 rounded-full flex items-center justify-center" style={{ backgroundColor: "var(--link-bg-15)", color: "var(--link-color)" }}>
                ...
                >
                  ...
                  <div>
                    <p className="font-['Space_Mono'] text-[10px] uppercase tracking-widest mb-0.5" style={{ color: "var(--text-muted)" }}>{tc("hqLabel")}</p>
                    <p className="font-['Space_Mono'] text-sm" style={{ color: "var(--text-primary)" }}>{tc("hqValue")}</p>
                  </div>
                </div>
              </div>
            </motion.div>
            ...
            <motion.div
              ...
              style={{ backgroundColor: "var(--bg-tint-85)", border: "1px solid var(--tint-border-15)" }}
            >
              <div className="absolute top-0 right-0 w-64 h-64 rounded-full blur-3xl -translate-y-1/2 translate-x-1/2 pointer-events-none" style={{ backgroundColor: "var(--tint-8)" }} />

              <ContactForm title={tc("formTitle")} />
            </motion.div>
          </div>
        </div>
      </section>
