...
import { Briefcase, MapPin, Clock, ArrowUpRight, HardHat, Wrench, Truck, FileCheck } from "lucide-react";

const JOB_OPENINGS = [
  {
    title: "Χειριστής Ασφαλτοστρωτήρα",
    type: "Πλήρης Απασχόληση",
    location: "Ηγουμενίτσα / Ήπειρος",
    desc: "Αναζητούμε έμπειρο χειριστή ασφαλτοστρωτήρα για ένταξη στα συνεργεία πεδίου μας. Απαιτείται εμπειρία τουλάχιστον 3 ετών.",
    icon: HardHat,
  },
  {
    title: "Χειριστής Εκσκαφέα",
    type: "Πλήρης Απασχόληση",
    location: "Ηγουμενίτσα / Ήπειρος",
    desc: "Ψάχνουμε χειριστή ερπυστριοφόρου εκσκαφέα με άδεια χειριστή Γ΄ κατηγορίας. Εμπειρία σε χωματουργικά έργα.",
    icon: Truck,
  },
  {
    title: "Μηχανικός Συντήρησης",
    type: "Πλήρης Απασχόληση",
    location: "Ηγουμενίτσα",
    desc: "Τεχνικός συντήρησης για τον στόλο μηχανημάτων μας. Γνώσεις υδραυλικών και μηχανολογικών συστημάτων.",
    icon: Wrench,
  },
  {
    title: "Πολιτικός Μηχανικός",
    type: "Πλήρης Απασχόληση",
    location: "Ηγουμενίτσα",
    desc: "Μηχανικός με εξειδίκευση σε οδοποιία και έργα υποδομής. Δυνατότητα διαχείρισης εργοταξίων και τεχνικής επίβλεψης.",
    icon: FileCheck,
  },
];

const BENEFITS = [
  { title: "Ανταγωνιστικός Μισθός", desc: "Αμοιβές ανάλογες της εμπειρίας και της ειδικότητας" },
  { title: "Ασφαλές Περιβάλλον", desc: "Αυστηρά πρωτόκολλα ασφάλειας σε κάθε εργοτάξιο" },
  { title: "Εξέλιξη & Εκπαίδευση", desc: "Συνεχής επαγγελματική κατάρτιση και αναβάθμιση δεξιοτήτων" },
  { title: "Σύγχρονος Εξοπλισμός", desc: "Εργασία με μηχανήματα τελευταίας τεχνολογίας" },
  { title: "Σταθερή Απασχόληση", desc: "Μακροχρόνια συνεργασία με σταθερή αναπτυξιακή πορεία" },
  { title: "Ομαδικό Πνεύμα", desc: "Φιλικό περιβάλλον εργασίας με αλληλοσεβασμό" },
];
...
export default function CareersPage() {
  return (
    <InnerPageLayout>
      <PageHero
        label="Καριερα"
        title={<>Χτισε Το<br /><span className="text-[#E63B2E]">Μελλον Σου.</span></>}
        subtitle="Γίνε μέλος μιας ομάδας που χτίζει υποδομές υψηλών προδιαγραφών. Αναζητούμε ταλαντούχους ανθρώπους που μοιράζονται το πάθος μας για τις κατασκευές."
      ...
      <section className="py-24 md:py-32 border-t border-white/5">
        <div className="container mx-auto px-6 max-w-7xl">
          <SectionHeading label="Πλεονεκτηματα" title={<>Γιατι <span className="text-[#E63B2E]">ΑΛΚΑΤΕΡ.</span></>} />
      ...
      <section className="py-24 md:py-32 bg-[#0a0a0a] border-t border-white/5">
        <div className="container mx-auto px-6 max-w-7xl">
          <SectionHeading label="Θεσεις" title={<>Ανοιχτες <span className="text-[#E63B2E]">Θεσεις.</span></>} />
        ...
        <div className="container mx-auto px-6 max-w-7xl text-center max-w-3xl">
          ...
          >
            <div className="flex justify-center items-center gap-4 mb-6">
              ...
              <span className="font-['Space_Mono'] uppercase tracking-widest text-sm text-[#E63B2E]">Αιτηση</span>
              <span className="w-8 h-[2px] bg-[#E63B2E]" />
            </div>
            <h2 className="text-3xl md:text-5xl font-bold tracking-tighter uppercase mb-8 leading-[1.1]">
              Δεν Βρηκες Αυτο Που<br /><span className="text-[#E63B2E]">Ψαχνεις;</span>
            </h2>
            <p className="font-['Space_Mono'] text-[#E8E4DD]/60 text-sm md:text-base leading-relaxed mb-10">
              Στείλε μας το βιογραφικό σου και θα επικοινωνήσουμε μαζί σου όταν προκύψει κατάλληλη θέση.
              Πάντα αναζητούμε ταλαντούχους ανθρώπους.
            </p>
            <a
