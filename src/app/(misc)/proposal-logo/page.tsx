...
// Adjusted colors to match the Alkater logo
const THEME = {
  primary: "#E8E4DD", // Background
  accent: "#A63336", // Logo Red
  secondary: "#1B5D6B", // Logo Blue/Teal
  dark: "#111111",
};
...
function Navbar() {
  ...
  return (
    <header className="fixed top-6 left-1/2 -translate-x-1/2 z-50 w-[90%] max-w-5xl transition-all duration-300">
      ...
      >
        <div className="font-['Space_Grotesk'] font-bold text-xl tracking-tighter w-32 relative h-8">
          <Image
        ...
        <Link
          href="#projects"
          className="group relative overflow-hidden rounded-full bg-[#A63336] px-6 py-2.5 text-sm font-['Space_Mono'] uppercase tracking-widest text-[#F5F3EE] hover:scale-[1.03] transition-all duration-300 ease-[cubic-bezier(0.25,0.46,0.45,0.94)]"
        >
    ...
    <section ref={comp} className="relative h-[100dvh] w-full bg-[#111111] overflow-hidden">
      ...
      <div className="absolute bottom-0 left-0 w-full h-full flex flex-col justify-end p-8 md:p-16 lg:p-24 pb-32">
        <div className="max-w-5xl">
          <p className="hero-text font-['Space_Mono'] text-[#1B5D6B] uppercase tracking-widest mb-6 border-l-2 border-[#1B5D6B] pl-4">
          ...
          <div className="hero-cta mt-12 md:mt-16">
             <Link
                href="#projects"
                className="group relative inline-flex overflow-hidden rounded-full bg-[#A63336] px-8 md:px-12 py-4 md:py-6 text-base md:text-lg font-['Space_Mono'] uppercase tracking-widest text-[#F5F3EE] hover:scale-[1.03] transition-all duration-300 ease-[cubic-bezier(0.25,0.46,0.45,0.94)]"
              >
  ...
  return (
    <section id="features" ref={comp} className="py-32 bg-[#F5F3EE] relative z-10 rounded-t-[3rem] -mt-8 px-6">
      <div className="container mx-auto max-w-7xl">
        <div className="mb-20">
           <p className="font-['Space_Mono'] text-[#A63336] uppercase tracking-widest text-sm mb-4 border-l-2 border-[#A63336] pl-4">01 // Capabilities</p>
          ...
          <div className="feature-card bg-[#111111] rounded-[2rem] p-8 h-96 flex flex-col group relative overflow-hidden">
            <div className="absolute top-8 right-8 flex items-center gap-2">
               <span className="relative flex h-3 w-3">
                <span className="animate-ping absolute inline-flex h-full w-full rounded-full bg-[#1B5D6B] opacity-75"></span>
                <span className="relative inline-flex rounded-full h-3 w-3 bg-[#1B5D6B]"></span>
              </span>
              <span className="font-['Space_Mono'] text-[#1B5D6B] text-xs">LIVE FEED</span>
            </div>
            ...
            <div className="flex-1 bg-black/50 rounded-xl p-4 border border-white/10 font-['Space_Mono'] text-[#E8E4DD] text-sm leading-relaxed relative overflow-hidden">
              ...
              {text}
              <span className="animate-pulse text-[#1B5D6B] ml-1">_</span>
            </div>
          </div>
             ...
             <div className="flex-1 border border-[#111111]/20 rounded-xl p-4 bg-white relative">
                ...
                <div className="grid grid-cols-7 gap-1">
                  {Array.from({length: 28}).map((_,i) => (
                    <div key={i} className={`aspect-square rounded-sm border border-[#111111]/5 ${i===15 || i===16 || i===17 ? 'bg-[#A63336]' : 'bg-[#F5F3EE]'}`}></div>
                  ))}
                </div>
  ...
  return (
    <section id="philosophy" ref={comp} className="py-40 bg-[#111111] relative overflow-hidden">
      ...
      <div className="phil-container container mx-auto px-6 max-w-5xl relative z-10 text-center">
        <p className="font-['Space_Mono'] text-[#A63336] uppercase tracking-widest text-sm mb-12">02 // Directive</p>
        ...
        <p className="phil-text-2 font-['DM_Serif_Display'] italic text-5xl md:text-7xl lg:text-8xl text-[#E8E4DD] leading-tight">
          We focus on: <span className="text-[#A63336] not-italic font-['Space_Grotesk'] font-bold tracking-tighter uppercase">Endurance.</span>
        </p>
      </div>
    </section>
  );
        ...
        {steps.map((step, i) => (
          <div key={i} className="protocol-card h-[100dvh] w-full flex items-center justify-center p-6 origin-top sticky top-0 bg-[#F5F3EE]" style={{ zIndex: steps.length - i }}>
            <div className="max-w-4xl w-full grid grid-cols-1 md:grid-cols-2 gap-12 items-center bg-white rounded-[3rem] p-12 shadow-[0_20px_60px_rgb(0,0,0,0.05)] border border-[#111111]/10">
              ...
              <div>
                <div className="font-['Space_Mono'] text-6xl md:text-8xl text-[#1B5D6B] opacity-20 font-bold mb-4">{step.num}</div>
...
function GetStarted() {
  return (
    <section className="py-32 bg-[#A63336] relative z-20 overflow-hidden">
      ...
      <div className="container mx-auto px-6 max-w-7xl">
        <div className="grid grid-cols-1 md:grid-cols-12 gap-12 mb-20">
          ...
          <div className="md:col-span-3">
             <h4 className="font-['Space_Mono'] text-[#A63336] text-xs uppercase tracking-widest mb-6 border-b border-[#F5F3EE]/10 pb-4">Δεδομενα</h4>
          ...
          <div className="md:col-span-3">
             <h4 className="font-['Space_Mono'] text-[#A63336] text-xs uppercase tracking-widest mb-6 border-b border-[#F5F3EE]/10 pb-4">Επικοινωνια</h4>
             <ul className="space-y-4 font-['Space_Mono'] text-sm text-[#F5F3EE]/70">
...
export default function ProposalLandingPage() {
  return (
    <div className="relative min-h-screen bg-[#F5F3EE] selection:bg-[#1B5D6B] selection:text-white font-['Space_Grotesk']">
      <style dangerouslySetInnerHTML={{__html: `
