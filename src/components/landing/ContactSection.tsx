...
export function ContactSection() {
  ...
  return (
    <section
      ...
      style={{ backgroundColor: "color-mix(in srgb, var(--bg-surface) 94%, var(--tint))" }}
    >
      ...
      <div className="container mx-auto px-6 max-w-7xl relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24">
          ...
          >
            ...
            <div className="space-y-8 mt-auto">
              <a
                ...
                style={{ backgroundColor: "color-mix(in srgb, color-mix(in srgb, var(--bg-primary) 85%, var(--link-color)) 75%, transparent)", border: "1px solid var(--border-color)" }}
              >
          ...
          >
            <div className="absolute top-0 right-0 w-64 h-64 rounded-full blur-3xl -translate-y-1/2 translate-x-1/2 pointer-events-none" style={{ backgroundColor: "color-mix(in srgb, var(--accent) 8%, transparent)" }}></div>
