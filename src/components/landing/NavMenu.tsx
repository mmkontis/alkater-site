  ...
  return (
    <>
      ...
      >
        ...
        >
          <div className="container mx-auto px-6 max-w-7xl flex items-center justify-between h-14">
            <Link href="/proposals/concept-1" className="inline-block">
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="65 60 295 70" className="h-8 w-auto transition-colors duration-500">
                <g fill="var(--logo-left)" className="transition-colors duration-500">
                ...
                <g fill="var(--logo-right)" className="transition-colors duration-500">
            ...
            <nav className="hidden md:flex items-center gap-6">
              {NAV_LINKS.slice(1).map((link) => (
                <Link
                  key={link.href}
                  href={link.href}
                  className="font-['Space_Mono'] text-[10px] uppercase tracking-[0.15em] hover:text-[#E63B2E] transition-colors"
