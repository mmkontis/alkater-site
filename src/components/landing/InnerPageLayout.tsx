...
export function InnerPageLayout({ children }: { children: React.ReactNode }) {
  ...
  return (
    <ThemeProvider>
    <main className="min-h-screen antialiased selection:bg-[#E63B2E] selection:text-white font-['Space_Grotesk']" style={{ backgroundColor: "color-mix(in srgb, var(--bg-primary) 97%, var(--tint))", color: "var(--text-primary)" }}>
      ...
      {menuOpen && (
        <div className="fixed inset-0 z-[90] backdrop-blur-xl flex items-center justify-center" style={{ backgroundColor: "color-mix(in srgb, var(--bg-primary) 95%, transparent)" }}>
    ...
    <section className="relative pt-32 pb-24 md:pt-40 md:pb-32 overflow-hidden">
      ...
      <div className="container mx-auto px-6 max-w-7xl relative z-10">
        <div className="flex items-center gap-4 mb-6">
          ...
          <span className="font-['Space_Mono'] uppercase tracking-widest text-sm" style={{ color: "var(--link-color, #E63B2E)" }}>{label}</span>
        </div>
